...
Instance RelSTs : Rel protocol := _.
Instance PreorderSTs : PreOrder (@rel protocol RelSTs) := _.
Instance STsSepAlgOps : SepAlgOps protocol := _.
Instance SepAlgSTs : SepAlg protocol := _.
Instance UUSepAlgSTs : UUSepAlg protocol := _.
...
Definition protocol_append (l r : protocol) : protocol :=
